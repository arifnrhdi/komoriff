...
const Jumbotrons = () => {
  return (
    <div className="flex flex-col items-center text-center xl:grid xl:grid-flow-col xl:grid-cols-12 xl:gap-28">
      ...
      <div className="mt-7 xl:col-span-5 xl:col-start-7 xl:mt-0">
        ...
        <div className="flex flex-row items-center justify-center gap-8 xl:justify-start xl:gap-12 xl:text-start">
          <a
            href="/about"
            className="rounded-lg bg-zinc-900 px-4 py-1 text-xl font-semibold text-gray-50 hover:opacity-85 lg:px-6 xl:mb-3 dark:bg-slate-200 dark:text-zinc-900"
          >
            About me
          </a>
        </div>
